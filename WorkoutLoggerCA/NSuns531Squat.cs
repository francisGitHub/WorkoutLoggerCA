...
{
    public class NSuns531Squat : NSunsWorkoutTemplate
    {
        public NSuns531Squat(DateTime entryDate, TrainingMaxStatistics tierOneTrainingMax, TrainingMaxStatistics tierTwoTrainingMax)
                                : base(entryDate, tierOneTrainingMax, tierTwoTrainingMax) { }

        protected override void GetTierTwoExercise()
        {
            _tierTwoExericise = new Exercise("Sumo Deadlift", ExerciseType.Back);
        }
        ...
        protected override void CreateTierTwoLifts()
        {
            ...
            this.TargetWorkoutSets.Add(new WorkoutSet(_tierTwoExericise, 8, 8, _tierTwoTrainingMax.TrainingMax * 0.70));
